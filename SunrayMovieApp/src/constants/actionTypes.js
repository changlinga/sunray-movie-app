...
export const PERSON_MOVIE_CREDITS_REQUEST = "PERSON_MOVIE_CREDITS_REQUEST";
export const PERSON_MOVIE_CREDITS_SUCCESS = "PERSON_MOVIE_CREDITS_SUCCESS";
export const PERSON_MOVIE_CREDITS_FAILURE = "PERSON_MOVIE_CREDITS_FAILURE";
